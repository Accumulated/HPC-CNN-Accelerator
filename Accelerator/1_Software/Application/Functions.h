...
void set_allocate_copy_Matrix_Device(Matrix *child, Matrix *parent, const char *notification);
...
void set_allocate_copy_array_Device(Matrix *child, float *parent, int height, int width, int depth, const char *notification);
...
void stop(const char *notification, int pause_time);

void after_pause(const char *notification);
