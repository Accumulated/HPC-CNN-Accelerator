...
MBConv_Abstraction MBConv1_0_Layers{
    ...
    .DepthWise{
        ...
        /* const const float MBConv1_0_depthwise_conv_conv2d_weights  [3 * 3 * 1 * 32] */
    ...
    .Project{
        ...
        /* const const float MBConv1_0_project_conv_conv2d_weights  [1 * 1 * 32 * 16] */
    ...
    .SQueezeExcite{
        ...
        .SQ1{
            /* const float MBConv1_0_squeeze_excitation1_conv2d_weights [8 * 32] */
        ...
        .SQ2{
            /* const float MBConv1_0_squeeze_excitation2_conv2d_weights [32 * 8] */
