...
MBConv_Abstraction MBConv6_2_Layers{
    ...
    .Expansion{
        ...
        /* const const float MBConv6_2_expansion_conv_conv2d_weights  [1 * 1 * 24 * 144] */
    ...
    .DepthWise{
        ...
        /* const const float MBConv6_2_depthwise_conv_conv2d_weights  [3 * 3 * 1 * 144] */
    ...
    .Project{
        ...
        /* const const float MBConv6_2_project_conv_conv2d_weights  [1 * 1 * 144 * 24] */
    ...
    .SQueezeExcite{
        .SQ1{
            /* const const float MBConv6_2_squeeze_excitation1_conv2d_weights  [1 * 1 * 144 * 6] */
        ...
        .SQ2{
            /* const const float MBConv6_2_squeeze_excitation2_conv2d_weights  [1 * 1 * 6 * 144] */
